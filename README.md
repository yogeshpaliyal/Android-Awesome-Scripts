...
# awesome-android-scripts

![buildStatus](https://img.shields.io/github/workflow/status/yogeshpaliyal/awesome-android-scripts/Java%20CI%20with%20Gradle?style=plastic)
![latestVersion](https://img.shields.io/github/v/release/yogeshpaliyal/awesome-android-scripts)
...
> Commonly used android utility scripts
...
Install npm package
```cmd
npm i -g android-awesome-scripts
```

Run a script
```cmd
android-awesome-scripts script-name
```
